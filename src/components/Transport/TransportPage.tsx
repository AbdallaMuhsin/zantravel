        ...
        <div className="mt-16 max-w-6xl mx-auto">
          {transportOptions.map((option, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`flex flex-col md:flex-row ${index % 2 === 0 ? '' : 'md:flex-row-reverse'} items-center gap-8 mb-16 last:mb-0`}
            >
              ...
              <div className="w-full md:w-1/2 p-6 md:p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <button 
                  onClick={() => navigate(`/booking?title=${encodeURIComponent(option.title)}`)} 
